...
/**
* Returns a function for evaluating the probability density function (PDF) for an anglit distribution with location parameter `mu` and scale parameter `sigma`.
*
