...
<!-- <div class="equation" align="center" data-raw-text="f(x) = \frac{1}{\sigma} \cos\left( \frac{2(x-\mu)}{\sigma} \right)" data-equation="eq:anglit_pdf">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@6aad72c2bcd622da9b9f2f3ff9d67daea5b895bd/lib/node_modules/@stdlib/stats/base/dists/anglit/pdf/docs/img/equation_anglit_pdf.svg" alt="Probability density function for an anglit distribution.">
    <br>
</div> -->
...
```javascript
import pdf from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-anglit-pdf@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-anglit-pdf@esm/index.mjs';
```
